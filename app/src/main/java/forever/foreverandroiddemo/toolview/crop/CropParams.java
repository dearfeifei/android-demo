...
public class CropParams {
    ...
    public static final int DEFAULT_COMPRESS_WIDTH = 900;
    public static final int DEFAULT_COMPRESS_HEIGHT = 900;
    public static final int DEFAULT_COMPRESS_QUALITY = 800;
