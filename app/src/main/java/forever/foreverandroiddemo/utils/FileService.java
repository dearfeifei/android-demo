...
public class FileService {
    ...
    public void save1(String fileName, String content) throws Exception {
    ...
    public void remove(String fileName,String content) throws Exception{

        String read = read(fileName);
        if (read.contains(content)) {
         read = read.replace(content+",","");
         System.out.println("切完的"+read);
