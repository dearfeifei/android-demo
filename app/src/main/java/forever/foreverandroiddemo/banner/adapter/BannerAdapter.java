package forever.foreverandroiddemo.banner.adapter;
...
import forever.foreverandroiddemo.banner.view.BannerViewPager;
...
public class BannerAdapter<T> extends PagerAdapter {
    ...
    public View getView(int position,View view,ViewGroup container){
        ...
        if (view == null){
            ...
            view.setTag(R.id.banner,holder);

        }else {
            holder = (Holder)view.getTag(R.id.banner);
        }
